...
from .settings import EXCLUDE_FUNCTION, EXCLUDE_APPS, \
...
class TabularPermissionsWidget(FilteredSelectMultiple):
    ...
    def render(self, name, value, attrs=None, renderer=None):
        ...
        VERSION = (2, 1, 0)
        old_django_has_view_perm = True if 'admin_view_permission' in settings.INSTALLED_APPS else False
        ...
        request_context = {'apps_available': apps_available, 'user_permissions': user_permissions,
                           ...
                           'colspan': colspan,
                           'django_supports_view_permissions': VERSION >= (2, 1, 0) or old_django_has_view_perm,}
